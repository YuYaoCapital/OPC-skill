...
**Macro Events**
- 央行货币政策会议 (PBOC / 美联储 FOMC)
- 国内宏观数据发布：CPI、PPI、PMI、GDP、社融、M2
- LPR 利率报价 (每月 20 日)
- 央行动态 (PBOC, ECB, BOJ, Fed)
...
- Earnings dates shift — verify against company IR pages, 巨潮资讯网, or Wind/同花顺 closer to the date
